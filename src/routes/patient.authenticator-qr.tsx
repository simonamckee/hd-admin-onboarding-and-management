...
export const Route = createFileRoute("/patient/authenticator-qr")({ component: PatientAuthQR });
...
function PatientAuthQR() {
  return (
    <Page>
      ...
      <PrimaryButton to="/patient/authenticator-verify">Continue to verification</PrimaryButton>
