...
export const Route = createFileRoute("/patient/complete-skipped")({ component: PatientCompleteSkipped });
...
function PatientCompleteSkipped() {
  return (
    <Page>
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <Body>Your account is ready. You can add 2-step verification at any time from My Profile → Security.</Body>
      </div>
